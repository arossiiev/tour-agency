            ...
            <div id="carouselExampleCaptions" className="carousel slide container-sm d-none d-sm-flex"  data-bs-ride="carousel" style={{width: "55rem", height: "30rem"}}>
                <div className="carousel-indicators">
                    {sights.map((sight, index)=>{
                        ...
                        return (
                            <button type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide-to={index} className={cc} aria-current="true" aria-label={`Slide ${index}`}></button>
                        )
                    })}

                </div>
                <div className="carousel-inner">
                    {sights.map(({imageUrl, name, description}, index)=>{
